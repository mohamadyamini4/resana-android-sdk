...
<div dir="ltr"><pre class="show-plain-default:true lang:default decode:true ">  implementation ('io.resana:resana:7.4.6@aar') {transitive = true}</pre></div>
...
<div dir="ltr"><pre class="lang:java decode:true">&lt;permission
...
<div dir="ltr"><pre class="lang:java decode:true">ResanaConfig resanaConfig = new ResanaConfig(ResanaConfig.AdType[], ResanaConfig.VisualType[]);

Resana.init(context, resanaConfig);</pre></div>
<p style="text-align: right;">برای مثال برای تبلیغات همسان با تصویر اصلی تکه کد زیر استفاده می‌شود:</p>

<div dir="ltr"><pre class="lang:java decode:true ">ResanaConfig resanaConfig = new ResanaConfig(new ResanaConfig.AdType[]{ResanaConfig.AdType.NATIVE}, new ResanaConfig.VisualType[]{ResanaConfig.VisualType.ORIGINAL});</pre></div>
<p style="text-align: right;"></p>
...
<div dir="ltr"><pre class="lang:java decode:true ">Resana resana;
resana = Resana.create(context);</pre></div>
<p style="text-align: right;"></p>
<p style="text-align: right;"><span style="font-weight: 400;">در پایان هر بخش برنامه برای غیر فعال کردن رسانا باید</span></p>

<div dir="ltr"><pre class="lang:java decode:true">resana.release()</pre></div>
...
<div dir="ltr"><pre class="lang:java decode:true">NativeAd ad = resana.getNativeAd(boolean hasTitle);
NativeAd ad = resana.getNativeAd(boolean hasTitle, String zone);</pre></div>
...
<div dir="ltr"><pre class="lang:java decode:true">Resana.getNativeAd(boolean hasTitle, String zone)</pre></div>
...
<div dir="ltr"><pre class="lang:java decode:true ">String NativeAd.getCallForAction()</pre></div>
<p style="text-align: right;"><span style="font-weight: 400;">متد ز یر رنگ پس زمینه ی تبلیغ را به صورت مبنای ۱۶ برمیگرداند.</span></p>

<div dir="ltr"><pre class="lang:default decode:true">String NativeAd.getBackgroundColor()
</pre></div>
<p style="text-align: right;"></p>
...
<div dir="ltr"><pre class="lang:default decode:true">String NativeAd.getMediumOrdinaryText()
</pre></div>
...
<div dir="ltr"><pre class="lang:default decode:true">String NativeAd.getShortTitleText()
</pre></div>
...
<div dir="ltr"><pre class="lang:default decode:true">String NativeAd.getMediumTitleText()
</pre></div>
...
&nbsp;</blockquote>
<div dir="ltr"><pre class="lang:default decode:true">int type = ad.getVisual().getSqVisual().getType()
...
int width = ad.getVisual().getHrzVisual().getWidth()</pre></div>
...
<div dir="ltr"><pre class="lang:java decode:true">File file = ad.getVisual().getHrzVisual().getFile()
Picasso.get().load(file).into(adImage);</pre></div>
<p style="text-align: right;"></p>
...
<div dir="ltr"><pre class="lang:default decode:true">resana.onNativeAdRendered(NativeAd ad)
</pre></div>
...
<div dir="ltr"><pre class="lang:java decode:true ">public interface AdDelegate {
...
<div dir="ltr"><pre class="lang:default decode:true ">public class MainActivity extends AppCompatActivity implements View.OnClickListener {
